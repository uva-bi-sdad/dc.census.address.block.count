#' Address Counts per Census Block for Idaho.
#.
#'
...
#' }
#' @source \url{https://www2.census.gov/geo/docs/reference/2020addresscountlist/16_Idaho_AddressBlockCountList_092021.txt}
