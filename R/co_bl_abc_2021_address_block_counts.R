#' Address Counts per Census Block for Colorado.
#.
#'
...
#' }
#' @source \url{https://www2.census.gov/geo/docs/reference/2020addresscountlist/08_Colorado_AddressBlockCountList_092021.txt}
