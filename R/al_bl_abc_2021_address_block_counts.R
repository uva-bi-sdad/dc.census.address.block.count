#' Address Counts per Census Block for Alabama.
#.
#'
...
#' }
#' @source \url{https://www2.census.gov/geo/docs/reference/2020addresscountlist/01_Alabama_AddressBlockCountList_092021.txt}
