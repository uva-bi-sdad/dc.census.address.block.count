#' Address Counts per Census Block for Washington.
#.
#'
...
#' }
#' @source \url{https://www2.census.gov/geo/docs/reference/2020addresscountlist/53_Washington_AddressBlockCountList_092021.txt}
