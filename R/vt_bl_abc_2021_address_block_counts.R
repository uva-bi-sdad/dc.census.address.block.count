#' Address Counts per Census Block for Vermont.
#.
#'
...
#' }
#' @source \url{https://www2.census.gov/geo/docs/reference/2020addresscountlist/50_Vermont_AddressBlockCountList_092021.txt}
