...
#' # 
#' # $metadata
#' # {"displayName":["Citation Metadata"],"fields":[{"typeName":"title","multiple":false,"typeClass":"primitive","value":["Social Data Commons - U.S. Census Block Address Counts"]},{"typeName":"subtitle","multiple":false,"typeClass":"primitive","value":["2021 Count of Housing Units and Group Quarters per Census Block in the U.S."]},{"typeName":"author","multiple":true,"typeClass":"compound","value":[{"authorName":{"typeName":"authorName","multiple":false,"typeClass":"primitive","value":"Schroeder, Aaron"},"authorIdentifierScheme":{"typeName":"authorIdentifierScheme","multiple":false,"typeClass":"controlledVocabulary","value":"ORCID"}}]},{"typeName":"datasetContact","multiple":true,"typeClass":"compound","value":[{"datasetContactName":{"typeName":"datasetContactName","multiple":false,"typeClass":"primitive","value":"Schroeder, Aaron"}}]},{"typeName":"dsDescription","multiple":true,"typeClass":"compound","value":[{"dsDescriptionValue":{"typeName":"dsDescriptionValue","multiple":false,"typeClass":"primitive","value":"2021 Count of Housing Units and Group Quarters per Census Block in the U.S."}}]},{"typeName":"subject","multiple":true,"typeClass":"controlledVocabulary","value":["Social Sciences (Ex: Education, Politics, Sociology, Economics, Psychology)"]},{"typeName":"productionDate","multiple":false,"typeClass":"primitive","value":["2021-11-04"]},{"typeName":"depositor","multiple":false,"typeClass":"primitive","value":["Schroeder, Aaron"]},{"typeName":"dateOfDeposit","multiple":false,"typeClass":"primitive","value":["2021-11-04"]}]} 
