#' Address Counts per Census Block for New Mexico.
#.
#'
...
#' }
#' @source \url{https://www2.census.gov/geo/docs/reference/2020addresscountlist/35_NewMexico_AddressBlockCountList_092021.txt}
