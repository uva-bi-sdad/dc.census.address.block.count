#' Address Counts per Census Block for Florida.
#.
#'
...
#' }
#' @source \url{https://www2.census.gov/geo/docs/reference/2020addresscountlist/12_Florida_AddressBlockCountList_092021.txt}
