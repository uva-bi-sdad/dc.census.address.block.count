#' Address Counts per Census Block for Georgia.
#.
#'
...
#' }
#' @source \url{https://www2.census.gov/geo/docs/reference/2020addresscountlist/13_Georgia_AddressBlockCountList_092021.txt}
