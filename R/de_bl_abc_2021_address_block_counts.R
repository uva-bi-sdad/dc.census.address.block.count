#' Address Counts per Census Block for Delaware.
#.
#'
...
#' }
#' @source \url{https://www2.census.gov/geo/docs/reference/2020addresscountlist/10_Delaware_AddressBlockCountList_092021.txt}
