#' Address Counts per Census Block for Rhode Island.
#.
#'
...
#' }
#' @source \url{https://www2.census.gov/geo/docs/reference/2020addresscountlist/44_RhodeIsland_AddressBlockCountList_092021.txt}
