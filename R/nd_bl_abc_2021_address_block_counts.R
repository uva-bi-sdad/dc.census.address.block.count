#' Address Counts per Census Block for North Dakota.
#.
#'
...
#' }
#' @source \url{https://www2.census.gov/geo/docs/reference/2020addresscountlist/38_NorthDakota_AddressBlockCountList_092021.txt}
