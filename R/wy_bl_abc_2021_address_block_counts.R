#' Address Counts per Census Block for Wyoming.
#.
#'
...
#' }
#' @source \url{https://www2.census.gov/geo/docs/reference/2020addresscountlist/56_Wyoming_AddressBlockCountList_092021.txt}
