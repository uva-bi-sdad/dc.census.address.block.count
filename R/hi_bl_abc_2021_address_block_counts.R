#' Address Counts per Census Block for Hawaii.
#.
#'
...
#' }
#' @source \url{https://www2.census.gov/geo/docs/reference/2020addresscountlist/15_Hawaii_AddressBlockCountList_092021.txt}
