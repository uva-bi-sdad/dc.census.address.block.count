#' Address Counts per Census Block for South Carolina.
#.
#'
...
#' }
#' @source \url{https://www2.census.gov/geo/docs/reference/2020addresscountlist/45_SouthCarolina_AddressBlockCountList_092021.txt}
