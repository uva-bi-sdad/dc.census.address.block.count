#' Address Counts per Census Block for North Carolina.
#.
#'
...
#' }
#' @source \url{https://www2.census.gov/geo/docs/reference/2020addresscountlist/37_NorthCarolina_AddressBlockCountList_092021.txt}
