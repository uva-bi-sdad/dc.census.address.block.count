#' Address Counts per Census Block for Texas.
#.
#'
...
#' }
#' @source \url{https://www2.census.gov/geo/docs/reference/2020addresscountlist/48_Texas_AddressBlockCountList_092021.txt}
