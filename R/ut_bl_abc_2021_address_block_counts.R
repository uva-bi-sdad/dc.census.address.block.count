#' Address Counts per Census Block for Utah.
#.
#'
...
#' }
#' @source \url{https://www2.census.gov/geo/docs/reference/2020addresscountlist/49_Utah_AddressBlockCountList_092021.txt}
