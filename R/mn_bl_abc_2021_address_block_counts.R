#' Address Counts per Census Block for Minnesota.
#.
#'
...
#' }
#' @source \url{https://www2.census.gov/geo/docs/reference/2020addresscountlist/27_Minnesota_AddressBlockCountList_092021.txt}
