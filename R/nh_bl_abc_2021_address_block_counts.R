#' Address Counts per Census Block for New Hampshire.
#.
#'
...
#' }
#' @source \url{https://www2.census.gov/geo/docs/reference/2020addresscountlist/33_NewHampshire_AddressBlockCountList_092021.txt}
