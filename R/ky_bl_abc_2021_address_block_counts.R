#' Address Counts per Census Block for Kentucky.
#.
#'
...
#' }
#' @source \url{https://www2.census.gov/geo/docs/reference/2020addresscountlist/21_Kentucky_AddressBlockCountList_092021.txt}
