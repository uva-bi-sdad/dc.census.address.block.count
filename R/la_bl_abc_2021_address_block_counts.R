#' Address Counts per Census Block for Louisiana.
#.
#'
...
#' }
#' @source \url{https://www2.census.gov/geo/docs/reference/2020addresscountlist/22_Louisiana_AddressBlockCountList_092021.txt}
