#' Address Counts per Census Block for Arizona.
#.
#'
...
#' }
#' @source \url{https://www2.census.gov/geo/docs/reference/2020addresscountlist/04_Arizona_AddressBlockCountList_092021.txt}
