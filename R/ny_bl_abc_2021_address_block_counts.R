#' Address Counts per Census Block for New York.
#.
#'
...
#' }
#' @source \url{https://www2.census.gov/geo/docs/reference/2020addresscountlist/36_NewYork_AddressBlockCountList_092021.txt}
