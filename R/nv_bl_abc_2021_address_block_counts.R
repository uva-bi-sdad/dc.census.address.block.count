#' Address Counts per Census Block for Nevada.
#.
#'
...
#' }
#' @source \url{https://www2.census.gov/geo/docs/reference/2020addresscountlist/32_Nevada_AddressBlockCountList_092021.txt}
